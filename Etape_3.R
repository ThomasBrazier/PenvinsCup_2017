#Vérifier que les noms de colonnes sont corrects
  cat("Vérification des noms des colonnes \n")
  fichier=readline("Quel est le nom du fichier à vérifier?") 
  ...
  for (i in 1:length(data)){
    ...
    }else{verif=TRUE} #si pas de différences, les noms sont confrmes
  }
...
cat("fin de la vérification du nom des colonnes")
